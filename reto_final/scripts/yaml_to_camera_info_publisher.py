...
if __name__ == "__main__":
    ...
    import argparse
    filename = "/home/hildab/catkin_ws/src/Autonomous_Navigation_TE3003B/reto_final/include/ost.yaml"
    ...
    publisher = rospy.Publisher("/puzzlebot_1/camera/camera_info", CameraInfo, queue_size=10)
    rate = rospy.Rate(10)
